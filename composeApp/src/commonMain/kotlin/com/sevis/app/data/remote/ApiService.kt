...
class UserApiService {
    suspend fun getAll(): List<User> =
        httpClient.get("$GATEWAY_BASE_URL/user-service/api/users").body()

    suspend fun getById(id: Long): User =
        httpClient.get("$GATEWAY_BASE_URL/user-service/api/users/$id").body()
    ...
    suspend fun delete(id: Long) =
        httpClient.delete("$GATEWAY_BASE_URL/user-service/api/users/$id")
}
